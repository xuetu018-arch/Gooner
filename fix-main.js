...
const before = txt.substring(0, txt.indexOf('ipcMain.handle(\\'folders:choose\\','));
const after = txt.substring(txt.indexOf('  const requestedHeight = Number(contentHeight);'));
